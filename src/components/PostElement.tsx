...
const PostElement = ({imageURL}: Props): JSX.Element => {
      ...
      <View style={[styles.topBar, {backgroundColor: Theme.post}]}>
        <View style={styles.locationAndOptions}>
          <Pressable style={styles.locationContainer}>
            <Text style={[styles.locationText, {color: Theme.text}]}>
              Chełm Śląski, <Text style={{color: '#3d84f5'}}>Poland</Text>
            </Text>
        ...
        <View style={styles.descriptionContainer}>
          <Description
            ...
            text={'Siemaneczko zieomeczki'.repeat(15)}
          />
        </View>
      </View>
      ...
      <View style={[styles.bottomBar, {backgroundColor: Theme.post}]}>
        <View style={styles.iconsContainer}>
          <Pressable style={styles.starIconContainer} onPress={toggleLike}>
            <Ionicons
              name={isLike ? 'md-star' : 'md-star-outline'}
              size={27}
              color={isLike ? '#3d84f5' : Theme.text}
            />
          </Pressable>
